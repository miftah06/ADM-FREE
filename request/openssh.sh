...
cp /etc/ssh/sshd_config /etc/ssh/sshd_back
fun_aplicadownload () {
wget -O /etc/ssh/sshd_config https://raw.githubusercontent.com/miftah06/ADM-FREE/master/Install/sshd_config
...
# wget -O /etc/pam.d/common-password https://raw.githubusercontent.com/miftah06/ADM-FREE/master/Install/common-password 
